...
import { ILate } from './_config/columns/columns.type';
import { useReportLate } from './_config/query';
import { statusOptions } from './_config/utiils';
...
const Info = () => {
	...
	const { data, isLoading, url, refetch } = useReportLate<ILate[]>(
		format(from, 'yyyy/MM/dd'),
		format(to, 'yyyy/MM/dd'),
		status
	);

	const pageInfo = useMemo(() => new PageInfo('Report/Late', url, 'report__late'), []);
